...
if (request.getAttribute("view_entries.jsp-dlViewFileVersionDisplayContext") != null) {
	dlViewFileVersionDisplayContext = (DLViewFileVersionDisplayContext)request.getAttribute("view_entries.jsp-dlViewFileVersionDisplayContext");
}

if (dlViewFileVersionDisplayContext == null) {
